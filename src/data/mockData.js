export const products = [
    {
        ...
        brandName: 'Apple',
        modelName: 'iPhone 15',
        productImage: '/images/apple_iPhone_15.png',
        availableColors: [
            {
                color: 'Black',
                stockAmount: 50,
    ...
    },
    {
        ...
        productImage: '/images/samsung_Galaxy_S23_FE.png',
        availableColors: [
            {
                color: 'Green',
                stockAmount: 10,
    ...
    },
    {
        ...
        productImage: '/images/xiaomi_Redmi_Note_13.png',
        availableColors: [
            {
                color: 'Blue',
                stockAmount: 0,
    ...
    },
    {
        ...
        productImage: '/images/sony_Xperia_10_V.png',
        availableColors: [
            {
                color: 'Black',
                stockAmount: 25,
        ...
        shortDescription:
            'A compact and stylish smartphone with a high-quality camera and a long-lasting battery.',
        pricePerMonth: 9,
        productType: 'Mobile phone',
    },
    {
        ...
        brandName: 'OnePlus',
        modelName: 'Nord 3',
        productImage: '/images/oneplus_Nord_3.png',
        availableColors: [
            {
                color: 'Grey',
                stockAmount: 100,
        ...
        shortDescription:
            'A mid-range smartphone with a fast processor, a large display, and a high-quality camera.',
        pricePerMonth: 15,
        productType: 'Mobile phone',
    },
];
